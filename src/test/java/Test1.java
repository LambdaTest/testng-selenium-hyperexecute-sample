...
public class Test1
{
	...
	public void testSetUp() throws Exception
    {
        ...
        capabilities.setCapability("build", "[HyperTest - 1] Demonstration of the TestNG Framework");
        capabilities.setCapability("name", "[HyperTest - 1] Demonstration of the TestNG Framework");
    ...
    @Test(description="To Do App on React App")
    public void test_element_addition2() throws InterruptedException
    {
        driver.get(testURL);
        Thread.sleep(5000);
